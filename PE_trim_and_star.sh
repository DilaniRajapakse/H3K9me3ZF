...
if [ -f "$genome" ]; then
  ...
  curl -s https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/049/306/965/GCF_049306965.1_GRCz12tu/GCF_049306965.1_GRCz12tu_genomic.fna.gz | gunzip -c > $OUTDIR/danio_refseq.fa
  genome=$OUTDIR/danio_refseq.fa
  echo "genome file is $genome"
fi
